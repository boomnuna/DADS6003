...
print(f"Train: {len(train)} rows, {pos} positives ({pos/len(train)*100:.2f}%)")
print(f"Test:  {len(test)} rows, {y_test.sum()} positives ({y_test.sum()/len(test)*100:.2f}%)")
...
print(f"Feature Set C: {X_train_C.shape[1]} features (same as A)")
...
print("\n" + "=" * 60)
print("STEP 4: XGBoost Fine-Tune (100 trials)")
print("=" * 60)
...
print("\n" + "=" * 60)
print("STEP 5: CatBoost Fine-Tune (100 trials)")
print("=" * 60)
