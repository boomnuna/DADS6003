...
if H >= 0.75:
    ...
    print(f"  Data has moderate cluster tendency (0.5 <= H < 0.75)")
else:
...
# Step 6 — Silhouette Plot per Cluster
...
# Step 7 — PCA vs t-SNE Visualization
...
print("=" * 75)
print(f"\nHopkins Statistic : H = {H}  ({'Clusterable' if H >= 0.75 else 'Moderate'})")
